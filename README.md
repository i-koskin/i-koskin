...
|-|-|
| [Автоматическая система детекции, распознавания автомобильных номеров в видео или с веб-камеры](https://github.com/i-koskin/License_Plate_Recognition_System_RUS)| Разработка системы для распознавания номерных знаков автомобилей на видео или с веб-камеры в реальном времени. Система выполняет обнаружение и OCR-распознавание номерных знаков с использованием PaddleOCR, отображение распознанных номеров и их сохранение, имеет встроенный веб-интерфейс для настройки параметров. |
