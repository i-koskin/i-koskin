...
| [Система обнаружения проникновения людей в запрещенные зоны)](https:https://github.com/i-koskin/Restricted_Zone_Monitor)| Разработка системы компьютерного зрения для автоматического обнаружения проникновений людей в запрещенные зоны с использованием YOLOv8 и DeepSORT на видео или с веб-камеры в реальном времени. Система выполняет обнаружение и трекинг объектов, формирует сигналы оповещения  при факте проникновения в запрещенные зоны с возможностью сохранения изображений. |
